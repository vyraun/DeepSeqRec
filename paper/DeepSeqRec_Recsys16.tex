...
%student knowledge is dynamic and hcompleted assignments are often the most relevant for recommending future problem sets.
...
model.  We also show that removing the model's memory leads to performance
